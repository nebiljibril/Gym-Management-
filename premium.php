...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['fname'], $_POST['lname'], $_POST['accno'], $_POST['email'], $_POST['username'])) {
    ...
    if ($stmt->num_rows == 0) {
        ...
        $query = "INSERT INTO memberrequest (accno, fname, lname, email, username, status, tier) VALUES (?, ?, ?, ?, ?, 'pending', 'premium')";
...
<body>
    <main>
        <section class="banner">
            <p>Transer the payment to our CBE account: 1000303080639</p>
          <h3>Includes: </h3>
          <p>Free WiFi</p>
          <p>Month to Month</p>
          <p>5hr per day</p>
        ...
        <section class = "side">
            <div class="cta">
                <p><span>Get Membership</span> premium</p>
            </div>
